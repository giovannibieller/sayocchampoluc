<?php
    ...
    function wp_inito_load_theme_textdomain() {
        load_theme_textdomain( 'sayoc-champoluc', get_template_directory() . '/lang' );
    }
    add_action( 'after_setup_theme', 'wp_inito_load_theme_textdomain' );

    // Register tr() function
    function tr($text){
        return _e($text, 'sayoc-champoluc');
    }
    ...
    function theme_widgets_init() {
        register_sidebar(array(
            'name'          => __('Primary Sidebar', 'sayoc-champoluc'),
            'id'            => 'sidebar-1',
            'description'   => __('Add widgets here to appear in your sidebar.', 'sayoc-champoluc'),
        ...
        register_sidebar(array(
            'name'          => __('Footer Widget Area', 'sayoc-champoluc'),
            'id'            => 'footer-1',
            'description'   => __('Add widgets here to appear in your footer.', 'sayoc-champoluc'),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget'  => '</section>',
